...
/**
 * Servlet implementation class SMSQuery
 */
@WebServlet("/SMSQuery")
public class SMSQuery extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ((isNotBlank(call) || isNotBlank(called)) && isNotBlank(startTime) && isNotBlank(endTime)) {
			try {
				...
				ret = QuerySMS.getListJsonData(call, called, startTime, endTime, sortName, sort);
